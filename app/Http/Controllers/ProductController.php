...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $product = Product::create([
            ...
            'v1_price' =>  $request->v1_price,
            'v2_price' =>  $request->v2_price,
            'v3_price' =>  $request->v3_price,
            'v4_price' =>  $request->v4_price,
            'v1_name' => $request->v1_name,
            'v2_name' => $request->v2_name,
            'v3_name' => $request->v3_name,
            'v4_name' => $request->v4_name,
            'vat' =>  $request->vat,
            'qty' =>  $request->qty,
            'body'  =>  $request->body,
