                    ...
                    <div class="card shadow mb-12" style="width:100%">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('menutype.update') }}">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="name" value="{{$menutype->name}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="from" type="time"  value="{{$menutype->from}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="from" type="time"  value="{{$menutype->to}}"
