                ...
                <div class="col-md-4">
                    <div class="card shadow mb-12" style="width:100%">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Update Payment Type</h6> 
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('pos.paymenttype.update') }}">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="name" value="{{$paymenttype->name}}"
