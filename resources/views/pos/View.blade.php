...
">
    ...
    <div id="invoice-POS" style="background: #e7e7e7; min-width:400px ; padding:20px">
        ...
        <center id="top">
          ...
          <div class="info"> 
            ...
            <div style="width: 100%; text-align:left; padding-top:20px" class="nn">
              <p>Date: <b>{{Carbon\Carbon::now()->isoFormat('LLLL') }}</b></p>
              <p>Invoice No: <b>#{{$order->id}}</b></p>
              <p>Member ID: <b>@if ($order->user)
                {{$order->user->memberid}}
            @endif</b></p>
