        ...
        <center id="top">
          ...
          <div class="info"> 
            ...
            <div style="width: 100%; float:right; text-align:center; padding-top:10px; margin-bottom:10px">
              ...
              <b style="padding: 6px 20px; background: #fff; font-weight: 400">RESETTLEMENT</b>
                        ...
                        <div id="table">
                            ...
                            {{-- @dd($product) --}}
                                ...
                                <tr class="tabletitle" style="border-top: 1px solid #333">
                                  <td class="Rate"  colspan="3"> </td>
                                  <td class="payment tar"><h2 style="text-align: center">{{$order->refund_balance}}</h2></td>
